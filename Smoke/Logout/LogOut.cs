...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Mouse", "(Optional Action)\r\nMouse Left Click item 'SURA.Copy_of_bttn_Aceptar' at Center.", repo.SURA.Copy_of_bttn_AceptarInfo, new RecordItemIndex(4));
                repo.SURA.Copy_of_bttn_Aceptar.Click();
                Delay.Milliseconds(0);
