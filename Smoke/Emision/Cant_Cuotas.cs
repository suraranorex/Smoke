...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 50s to exist. Associated repository item: 'SURA.option_Pago'", repo.SURA.option_PagoInfo, new ActionTimeout(50000), new RecordItemIndex(2));
