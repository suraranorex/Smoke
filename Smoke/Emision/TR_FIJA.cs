...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TR_FIJA recording.
    /// </summary>
    [TestModule("88a2064f-ed3e-49d0-a751-46616f74153c", ModuleType.Recording, 1)]
    public partial class TR_FIJA : ITestModule
    {
        /// <summary>
        ...
        static TR_FIJA instance = new TR_FIJA();
        ...
        /// </summary>
        public static TR_FIJA Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("24626f4a-ed61-44d0-a809-f0c381037999")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Franquicia' with focus on 'SURA.txt_Franquicia'.", repo.SURA.txt_FranquiciaInfo, new RecordItemIndex(0));
            repo.SURA.txt_Franquicia.PressKeys(Franquicia);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Value' from item 'SURA.txt_Franquicia' and assigning its value to variable 'Franquicia'.", repo.SURA.txt_FranquiciaInfo, new RecordItemIndex(1));
            Franquicia = repo.SURA.txt_Franquicia.Element.GetAttributeValueText("Value");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", Franquicia, new RecordItemIndex(2));
